        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-[var(--text-muted)] leading-relaxed mb-6 text-base">
              ...
              — a Tokyo-based technology leader with 26+ years of expertise in
          ...
          >
            ...
            <div className="relative rounded-3xl overflow-hidden border border-[var(--border)] bg-[var(--bg-card)] p-8">
              ...
              <div className="grid grid-cols-1 gap-3">
                {[{ label: "Years Active", value: "6+", color: "green" }].map(
                  ({ label, value, color }) => (
                    <div
                      key={label}
                    ...
                    >
                      ...
                      <div className="text-[var(--text-subtle)] text-xs mt-1">
                        {label}
                      </div>
                    </div>
                  ),
            ...
            {/* Floating Japanese text badge removed — see Japan Partnership section */}
          </motion.div>
        </div>
      </div>
    </section>
