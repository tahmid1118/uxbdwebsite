...
const milestones = [
  {
    year: "2019",
    event:
      "Ultra-X BD established on 1st September 2019 as Bangladesh development partner of Ultra-X Japan",
  },
  {
    year: "2020",
    event:
      "Delivered first major product: PC Checkup enhancements and Windows diagnostic suite",
  },
  {
    year: "2021",
    event: "Expanded to mobile — developed iOS and Android diagnostic modules",
  },
  {
    year: "2022",
    event: "Launched Mobile Pliers and NextErase, marking 20+ products shipped",
  },
  {
    year: "2023",
    event:
      "Team grew to 20+ engineers; shipped TENKAI OS Manager and UltraPOST",
  },
  {
    year: "2024",
    event: "Achieved 50+ project milestone with 100% client retention",
  },
  {
    year: "2025+",
    event:
      "Expanding into AI-powered diagnostics and cloud-based device management",
  },
];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-[var(--text-primary)] leading-tight mb-6">
              Built in <span className="gradient-text-green">Bangladesh</span>
              <br />
              for <span className="gradient-text-red">Japan</span>
            </h1>
            <p className="text-[var(--text-muted)] text-xl leading-relaxed max-w-2xl">
              Ultra-X BD was established on 1st September 2019 with a single
              mission: to engineer world-class IT software that meets
              Japan&apos;s legendary standards for quality and reliability —
              powered by Bangladesh&apos;s exceptional engineering talent.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            >
              ...
              <div className="space-y-4 text-[var(--text-muted)] leading-relaxed">
                <p>
                  ...
                  , a Tokyo-headquartered technology company founded in 2000.
                  Ultra-X Japan develops hardware diagnostic tools, data erasure
                  solutions, and OS deployment systems that are used by PC
                  manufacturers, reuse businesses, and enterprise IT teams
                  across Japan.
                </p>
                <p>
                  Our Bangladesh team handles the full software development
                  lifecycle — from design and architecture through coding,
                  testing, and maintenance. We work in close collaboration with
                  the Japan team, following agile sprints with Japanese-standard
                  QA processes.
                </p>
                <p>
                  What makes Ultra-X BD unique is our deep specialization in
                  systems software: we work at the firmware level, in UEFI
                  environments, with Windows kernel APIs, and on mobile
                  platforms — a rare combination that allows us to deliver the
                  complexity Japan demands.
                </p>
              </div>
              ...
              <div className="mt-8 p-5 rounded-2xl bg-[var(--bg-card)] border border-[var(--border)]">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {[
                    { label: "Established", value: "1 Sep 2019" },
                    { label: "Products", value: "50+" },
                    { label: "Engineers", value: "20+" },
                    { label: "Satisfaction", value: "100%" },
                  ].map(({ label, value }) => (
                    <div key={label} className="text-center">
                      <div className="text-2xl font-black gradient-text-red">
                        {value}
                      </div>
          ...
          <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {teamMembers.map((member, idx) => (
              ...
              >
                ...
                <h3 className="text-[var(--text-primary)] font-semibold text-base mb-0.5">
                  {member.name}
                </h3>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <div className="flex items-center justify-center gap-6 mb-6">
              ...
              <div className="text-[var(--text-subtle)] text-2xl font-thin">
                ⟷
              </div>
              <div className="flex flex-col items-center">
                <span className="text-4xl mb-2">🇯🇵</span>
            ...
            <p className="text-[var(--text-muted)] text-sm leading-relaxed max-w-2xl mx-auto">
              Building a strong Japan–Bangladesh technology bridge since 2019.
